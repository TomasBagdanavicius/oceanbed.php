...
$test_cases = [
    ...
    ['input' => 'abcde', 'compare' => 'abc', 'case_sensitive' => true, 'accent_sensitive' => true, 'expected' => true],
    // Case-insensitive tests
    ['input' => 'abcde', 'compare' => 'Abc', 'case_sensitive' => false, 'accent_sensitive' => true, 'expected' => true],
    ['input' => 'abcde', 'compare' => 'Ąbč', 'case_sensitive' => false, 'accent_sensitive' => true, 'expected' => false],
    // Case-insensitive and accent-insensitive tests
    ['input' => 'abcde', 'compare' => 'Ąbč', 'case_sensitive' => false, 'accent_sensitive' => false, 'expected' => true],
...
foreach ($test_cases as $key => $case) {
    ...
    $result = $compliance_comparison->startsWith($case['compare']);

...
$condition_1 = new Condition('name', 'John', ConditionComparisonOperatorsEnum::NOT_EQUAL_TO);
$condition_2 = new Condition('age', 20, ConditionComparisonOperatorsEnum::EQUAL_TO);
$condition_3 = new Condition('sex', 'female', ConditionComparisonOperatorsEnum::EQUAL_TO);
$condition_4 = new Condition('occupation', 'teacher', ConditionComparisonOperatorsEnum::NOT_EQUAL_TO);
$condition_5 = new Condition('age', 30, ConditionComparisonOperatorsEnum::EQUAL_TO);
$condition_6 = new Condition('sex', 'male', ConditionComparisonOperatorsEnum::EQUAL_TO);
$condition_7 = new Condition('age', 20, ConditionComparisonOperatorsEnum::EQUAL_TO);
...
$condition_group_2->add($condition_4);
$condition_group_2->add($condition_5, NamedOperatorsEnum::OR);

$condition_group_3 = new ConditionGroup();
$condition_group_3->add(new Condition('occupation', 'engineer', ConditionComparisonOperatorsEnum::NOT_EQUAL_TO));
$condition_group_3->add($condition_group_1, NamedOperatorsEnum::OR);
$condition_group_3->add($condition_group_2, NamedOperatorsEnum::AND);

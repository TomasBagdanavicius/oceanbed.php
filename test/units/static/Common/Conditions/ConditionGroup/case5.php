...
# var_dump( ((t(1) or f(2) and f(3)) or (f(4) and f(5)) and f(6) or t(7)) or f(8) );
...
$condition_group_2->add($condition_5, NamedOperatorsEnum::AND);

$condition_group_3 = new ConditionGroup();
$condition_group_3->add($condition_group_1);
$condition_group_3->add($condition_group_2, NamedOperatorsEnum::OR);
$condition_group_3->add($condition_6, NamedOperatorsEnum::AND);
$condition_group_3->add($condition_7, NamedOperatorsEnum::OR);

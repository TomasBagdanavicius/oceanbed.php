...
# var_dump( (f(1) and t(2)) or (t(3) and ((t(4) and (f(5) or t(6))) or f(7))) and t(8) );
...
$condition_group_2->add($condition_5);
$condition_group_2->add($condition_6, NamedOperatorsEnum::OR);

$condition_group_3 = new ConditionGroup();
$condition_group_3->add($condition_4);
$condition_group_3->add($condition_group_2, NamedOperatorsEnum::AND);

$condition_group_4 = new ConditionGroup();
$condition_group_4->add($condition_group_3);
$condition_group_4->add($condition_7, NamedOperatorsEnum::OR);

$condition_group_5 = new ConditionGroup();
$condition_group_5->add($condition_3);
$condition_group_5->add($condition_group_4, NamedOperatorsEnum::AND);

$condition_group_root = new ConditionGroup();
$condition_group_root->add($condition_group_1);
$condition_group_root->add($condition_group_5, NamedOperatorsEnum::OR);
$condition_group_root->add($condition_8, NamedOperatorsEnum::AND);

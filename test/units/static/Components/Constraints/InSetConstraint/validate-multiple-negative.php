...
$validation_result = $validator->validate(['one', 'three', 'six']);

Demo\assert_true(
    $validation_result instanceof InSetConstraintViolation && array_values($validation_result->missing_values) === ['six'],

...
// Prop 2 matches Prop 1.
$relational_property_2->setupRelation('match', 'prop_1');
// Prop 2 is an alias or Prop 3.
$relational_property_2->setupRelation('alias', 'prop_3');

// Both properties match.
$relational_model->prop_1 = "Value 1";
$relational_model->prop_2 = "Value 1";

// Since prop 2 already has its OWN value, prop 3 will not modify it.
$relational_model->prop_3 = "Value 3";
